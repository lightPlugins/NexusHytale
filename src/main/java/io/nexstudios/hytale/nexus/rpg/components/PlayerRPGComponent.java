package io.nexstudios.hytale.nexus.rpg.components;
...
import io.nexstudios.hytale.nexus.rpg.level.XPTable;
import org.checkerframework.checker.nullness.compatqual.NullableDecl;

public class PlayerRPGComponent implements Component<EntityStore> {

    public static ComponentType<EntityStore, PlayerRPGComponent> TYPE;
    ...
    public void setTotalExperience(long xp) {
        this.totalExperience = Math.max(0, xp);
    }
